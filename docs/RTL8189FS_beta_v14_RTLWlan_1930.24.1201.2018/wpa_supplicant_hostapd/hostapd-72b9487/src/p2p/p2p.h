...
#define P2P_SEC_DEVICE_TYPES 5
...
#ifdef CONFIG_ASP
	void (*prov_disc_req_sent)(void *ctx, int success);
	void (*go_neg_req_sent)(void *ctx, int success);
	void (*p2ps_prov_disc_req_recvd)(void *ctx, const u8 *dev,
					 const char *dev_name,
	 ...
	 */
  void (*p2ps_prov_complete)(void *ctx, const struct p2ps_provision *p2ps_prov,

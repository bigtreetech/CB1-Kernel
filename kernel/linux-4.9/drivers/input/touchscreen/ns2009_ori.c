...
static int ns2009_ts_report(struct ns2009_data *data)
{
	...
	if (z1 >= NS2009_PEN_UP_Z1_ERR) {
        ...
        int x1=0,y1=0;
 		...
 		//x1 = (x*1000/4096 * SCREEN_X_PIXEL)/1000; //4096 = 2 ^ 12
		//y1 = (y*1000/4096 * SCREEN_Y_PIXEL)/1000;  
        
        //swap x
      //  x1 = SCREEN_X_PIXEL - x1;
        //y1 = SCREEN_Y_PIXEL - y1;
        
      //  printk("==> report x,y = [%d %d]\n", x1, y1);
        
#if 0   
        printk("ori x,y = [%d %d] ==>",x, y);

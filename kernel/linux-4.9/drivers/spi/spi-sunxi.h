...
#define SPI_DBI_CR_REG		(0x100)	/* DBI control register, only for 1851*/
#define SPI_DBI_CR_REG1		(0x104)	/* DBI control register, only for 1851*/
#define SPI_DBI_CR_REG2		(0x108)	/* DBI control register, only for 1851*/
#define SPI_DBI_TIMER_REG       (0x10C)	/* DBI timer register, only for 1851*/
#define SPI_DBI_VIDEO_SIZE	(0x110)	/* DBI VIDEO SIZE register, for 1851 */

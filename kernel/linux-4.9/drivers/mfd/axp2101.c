...
static const struct regmap_range axp806_volatile_ranges[] = {
	regmap_reg_range(AXP806_STARTUP_SRC, AXP2202_TWI_ADDR_EXT),
};
...
static const struct regmap_range axp803_writeable_ranges[] = {
	regmap_reg_range(AXP803_STATUS, AXP803_ADJUST_PARA1),
};
...
static const struct regmap_config axp803_regmap_config = {
	...
	.max_register	= AXP803_ADJUST_PARA1,
	.cache_type	= REGCACHE_RBTREE,
};
...
static struct resource axp803_power_supply_resources[] = {
...
static struct mfd_cell axp806_cells[] = {
	{
		.name = "axp806-nvmem",
		.of_compatible = "x-powers,axp806-nvmem",
	},
	{
		.name = "axp2101-pek",
...
static struct mfd_cell axp803_cells[] = {
	...
	},
	{
		...
		.of_compatible = "x-powers,axp803-power-supply",
		.num_resources = ARRAY_SIZE(axp803_power_supply_resources),
		.resources = axp803_power_supply_resources,
	},
	{
		.of_compatible = "xpower-vregulator,dcdc1",
		.name = "reg-virt-consumer",

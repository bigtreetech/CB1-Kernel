...
//Some ETF CLI parameters are saved to the driver
#define M_RATE_INDEX                0
#define M_GN_MODE_FORCE             1
#define M_PHY_MODE                  2
#define M_CHANNEL                   3
#define M_MODE                      4
#define M_RATE                      5
#define M_BANDWIDTH                 6
#define M_SUBCHANNEL                7
#define M_CONTINUOUS                8
#define M_PACKET_LEN                9
#define M_TX_GI                     10
#define M_FREQ_OFFSET               11
#define M_SDD_FREQ_OFFSET           12
#define M_TX_FLAG                   13
#define M_RX_FLAG                   14
#define M_REGULATORY_CLASS          15
#define M_ACK_FLAG                  16
#define M_RESERVE0                  17
#define M_RESERVE1                  18
#define M_RESERVE2                  19
#define M_RESERVE3                  20
#define M_RESERVE4                  21
#define M_RESERVE5                  22
#define M_RESERVE6                  23
#define M_RESERVE7                  24

typedef struct ETFCLI_PAR_S {
	u16 	g_iRateIndex;            //0
	u16 	g_iGnModeForce;          //1
	u16 	phy_mode;                //2
	u16 	channel;                 //3
	u16 	mode;                    //4
	u16 	reat;                    //5
	...
	u16 	continuous;              //8
	u16	packet_length;           //9
	s16 	Tx_guard_interval;       //10
	u16 	freqoffset;              //11
	u16 	sdd_freq_offset;         //12
	u16 	tx_flag;                 //13
	u16 	rx_flag;                 //14
	u16 	regulatory_class;        //15
	u16 	ack_flag;                //16
	u16 	reserve0;                //17
	u16 	reserve1;                //18
	u16 	reserve2;                //19

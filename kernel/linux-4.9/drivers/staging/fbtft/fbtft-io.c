...
int fbtft_write_spi(struct fbtft_par *par, void *buf, size_t len)
{
   ...
   // printk("==> spi write: len=%d\n",len);

	//fbtft_par_dbg_hex(DEBUG_WRITE, par, par->info->device, u8, buf, len,"%s(len=%zu): ", __func__, len);
...
int fbtft_write_gpio16_wr(struct fbtft_par *par, void *buf, size_t len)
{
    ...
    printk("==> 16bit %s(len=%zu): ", __func__, len);

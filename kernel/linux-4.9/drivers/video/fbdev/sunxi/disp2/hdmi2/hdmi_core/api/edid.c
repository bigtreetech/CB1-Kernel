...
/* pclk  I/P Ha   Hb                          Va   Vb */
    ...
    {50000, { 19, 0, 0, 0, 74250, 0, 1280,  700, 0, 16,  440,  40, 1,  720, 30, 0, 9,  5,  5, 1} }, //1280x720 
   ...
   // {60000, { 110, 0, 0, 0, 74250, 0, 800,  128, 0, 16,   40,  32, 0, 480, 45, 0, 9,  2,  5, 0} },//800x480
    {60000, { 110, 0, 0, 0, 54000, 0, 800,  128, 0, 16,   40,  32, 0, 480, 45, 0, 9,  2,  5, 0} },//800x480
    {60000, { 111, 0, 0, 0, 74250, 0, 1024,  320, 0, 16,   168,  32, 1, 600, 35, 0, 9,  2,  5, 1} },//36 1024x600
...
dtd_t *get_dtd(u32 code, u32 refreshRate)
{
	...
	for (i = 0; _dtd[i].dtd.mCode != 0; i++) {
		if (_dtd[i].dtd.mCode == code) {
            ...
            {
               // printk("===> dtd index = %d\n",i);
                printk("===> dtd index %d w:h = %dx%d mPixelClock = %d\n",i,_dtd[i].dtd.mHActive,_dtd[i].dtd.mVActive, _dtd[i].dtd.mPixelClock);
				return &_dtd[i].dtd;
            }

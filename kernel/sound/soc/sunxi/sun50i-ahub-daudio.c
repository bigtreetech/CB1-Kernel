...
static int sunxi_ahub_daudio_init_fmt(struct sunxi_ahub_daudio_priv
                                          *sunxi_ahub_daudio,
                                      unsigned int fmt, unsigned int id)
{
    ...
    struct sunxi_ahub_daudio_priv *sunxi_ahub_daudio, int id)
{
    ...
    sunxi_ahub_daudio_init_fmt(sunxi_ahub_daudio,
                               (sunxi_ahub_daudio->audio_format | (sunxi_ahub_daudio->signal_inversion << 8) | (sunxi_ahub_daudio->daudio_master << 12)), id);
                                       ...
                                       struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
    ...
    /* default setting the daudio fmt */
    sunxi_ahub_daudio_init_fmt(sunxi_ahub_daudio,
                               (sunxi_ahub_daudio->audio_format | (sunxi_ahub_daudio->signal_inversion << 8) | (sunxi_ahub_daudio->daudio_master << 12)),
                               sunxi_ahub_daudio->tdm_num);

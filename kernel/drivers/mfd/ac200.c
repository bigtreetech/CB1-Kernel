...
static uint32_t ephy_caldata = 0;
...
MODULE_DESCRIPTION("MFD core driver for AC200 & AC300");
MODULE_AUTHOR("Jernej Skrabec <jernej.skrabec@siol.net>, huangxin<huangxin@allwinnertech.com>");

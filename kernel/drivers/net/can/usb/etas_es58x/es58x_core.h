...
#define ES58X_MAX(param) \
    (ES581_4_##param > ES58X_FD_##param ? ES581_4_##param : ES58X_FD_##param)
...
union es58x_urb_cmd
{
    ...
    struct
    { /* Common header parts of all variants */
        __le16 sof;
        u8 cmd_type;
        u8 cmd_id;
    } __packed;
...
#define ES58X_SIZEOF_URB_CMD(es58x_urb_cmd_type, msg_field) \
    (offsetof(es58x_urb_cmd_type, raw_msg) + sizeof_field(es58x_urb_cmd_type, msg_field) + sizeof_field(es58x_urb_cmd_type, reserved_for_crc16_do_not_use))

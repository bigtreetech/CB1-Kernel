...
#define CONFIG_ARCH_SUN50IW12
#define CONFIG_ARCH_SUN50IW12P1
...
/* sram layout*/
#define CONFIG_SYS_SRAM_BASE             (0x104000)
#define CONFIG_SYS_SRAM_SIZE             (0x01C000)
#define CONFIG_SYS_SRAMA2_BASE           (0x100000)
#define CONFIG_SYS_SRAMA2_SIZE           (0x01C000)

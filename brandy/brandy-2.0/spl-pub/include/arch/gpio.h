...
#define BANK_TO_GPIO(bank)                                                     \
	(((bank) < SUNXI_GPIO_L) ?                                             \
		 ...
		 &((struct sunxi_gpio_reg *)SUNXI_R_PIO_BASE)                  \
			  ->gpio_bank[(bank)-SUNXI_GPIO_L])
 ...
 *
-##############################################################################################################*/
#define PIO_REG_CFG(n, i)                                                      \
	((volatile unsigned int *)(SUNXI_PIO_BASE + ((n)-1) * 0x24 +           \
				   ((i) << 2) + 0x00))
#define PIO_REG_DLEVEL(n, i)                                                   \
	((volatile unsigned int *)(SUNXI_PIO_BASE + ((n)-1) * 0x24 +           \
				   ((i) << 2) + 0x14))
#define PIO_REG_PULL(n, i)                                                     \
	((volatile unsigned int *)(SUNXI_PIO_BASE + ((n)-1) * 0x24 +           \
				   ((i) << 2) + 0x1C))
#define PIO_REG_DATA(n)                                                        \
	((volatile unsigned int *)(SUNXI_PIO_BASE + ((n)-1) * 0x24 + 0x10))
#define PIO_ONE_PIN_DATA(n, i)                                                 \
	(((*(volatile unsigned int *)(SUNXI_PIO_BASE + ((n)-1) * 0x24 +        \
				      0x10)) &                                 \
	  (1 << i)) >>                                                         \
	 i)

#define PIO_REG_CFG_VALUE(n, i)                                                \
	readl(SUNXI_PIO_BASE + ((n)-1) * 0x24 + ((i) << 2) + 0x00)
#define PIO_REG_DLEVEL_VALUE(n, i)                                             \
	readl(SUNXI_PIO_BASE + ((n)-1) * 0x24 + ((i) << 2) + 0x14)
#define PIO_REG_PULL_VALUE(n, i)                                               \
	readl(SUNXI_PIO_BASE + ((n)-1) * 0x24 + ((i) << 2) + 0x1C)
#define PIO_REG_DATA_VALUE(n) readl(SUNXI_PIO_BASE + ((n)-1) * 0x24 + 0x10)
#define PIO_REG_BASE(n)                                                        \
	((volatile unsigned int *)(SUNXI_PIO_BASE + ((n)-1) * 24))

#ifdef SUNXI_R_PIO_BASE
#define R_PIO_REG_CFG(n, i)                                                    \
	((volatile unsigned int *)(SUNXI_R_PIO_BASE + ((n)-12) * 0x24 +        \
				   ((i) << 2) + 0x00))
#define R_PIO_REG_DLEVEL(n, i)                                                 \
	((volatile unsigned int *)(SUNXI_R_PIO_BASE + ((n)-12) * 0x24 +        \
				   ((i) << 2) + 0x14))
#define R_PIO_REG_PULL(n, i)                                                   \
	((volatile unsigned int *)(SUNXI_R_PIO_BASE + ((n)-12) * 0x24 +        \
				   ((i) << 2) + 0x1C))
#define R_PIO_REG_DATA(n)                                                      \
	((volatile unsigned int *)(SUNXI_R_PIO_BASE + ((n)-12) * 0x24 + 0x10))

#define R_PIO_REG_CFG_VALUE(n, i)                                              \
	readl(SUNXI_R_PIO_BASE + ((n)-12) * 0x24 + ((i) << 2) + 0x00)
#define R_PIO_REG_DLEVEL_VALUE(n, i)                                           \
	readl(SUNXI_R_PIO_BASE + ((n)-12) * 0x24 + ((i) << 2) + 0x14)
#define R_PIO_REG_PULL_VALUE(n, i)                                             \
	readl(SUNXI_R_PIO_BASE + ((n)-12) * 0x24 + ((i) << 2) + 0x1C)
#define R_PIO_REG_DATA_VALUE(n) readl(SUNXI_R_PIO_BASE + ((n)-12) * 0x24 + 0x10)
#define R_PIO_REG_BASE(n)                                                      \
	((volatile unsigned int *)(SUNXI_R_PIO_BASE + ((n)-12) * 24))
#endif

...
static void setup_hdmi_tag(bd_t *bd)
{
	params->hdr.tag = ATAG_HDMI_PARAM;
	params->hdr.size = tag_size(tag_hdmi_param);
	params->u.hdmi_param.width = hdmi_width;
    params->u.hdmi_param.height = hdmi_height;
    params->u.hdmi_param.mode = hdmi_mode;
	params = tag_next (params);
}

...
s32 tcon_de_attach(u32 tcon_index, u32 de_index)
{
	...
	printf("%s:de=%d,tcon=%d", __func__, de_index, tcon_index);
	if (de_index == 0) {
#if defined(CONFIG_MACH_SUN50IW6)
...
static s32 tcon0_cfg_mode_auto(u32 sel, disp_panel_para *panel, u32 de_use_rcq)
{
	s32 start_delay;
...
s32 tcon0_cfg(u32 sel, disp_panel_para *panel, u32 de_use_rcq)
{

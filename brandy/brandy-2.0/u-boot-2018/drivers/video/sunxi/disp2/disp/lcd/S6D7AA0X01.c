/*
 * drivers/video/sunxi/disp2/disp/lcd/S6D7AA0X01.c
 *
...
static void LCD_panel_init(u32 sel)
{
	...
	sunxi_lcd_dsi_dcs_write_1para(sel,0x22,0x0E);     //PA[6]=0, PA[5]=0, PA[4]=0, PA[0]=0 
	
	//SETPANEL
	sunxi_lcd_dsi_dcs_write_1para(sel,0x37,0x19);	//SS=1,BGR=1
	
	//SET RGBCYC
	sunxi_lcd_dsi_dcs_write_1para(sel,0x38,0x05);	//JDT=101 zigzag inversion
	sunxi_lcd_dsi_dcs_write_1para(sel,0x39,0x08);	//RGB_N_EQ1, modify 20140806
	sunxi_lcd_dsi_dcs_write_1para(sel,0x3A,0x12);	//RGB_N_EQ2, modify 20140806
	sunxi_lcd_dsi_dcs_write_1para(sel,0x3C,0x78);	//SET EQ3 for TE_H
	sunxi_lcd_dsi_dcs_write_1para(sel,0x3E,0x80);	//SET CHGEN_OFF, modify 20140806 
	sunxi_lcd_dsi_dcs_write_1para(sel,0x3F,0x80);	//SET CHGEN_OFF2, modify 20140806
	...
	//--- power voltage  ----//
	sunxi_lcd_dsi_dcs_write_1para(sel,0x55,0x01);	//DCDCM=0001, JD PWR_IC
	...
	sunxi_lcd_dsi_dcs_write_1para(sel,0x98,0x2F);	//From 2E to 2F, LED_VOL
...
__lcd_panel_t S6D7AA0X01_panel = {

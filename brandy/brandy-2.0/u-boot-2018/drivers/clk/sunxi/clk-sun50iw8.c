...
SUNXI_CLK_PERIPH(g2d,            G2D_CFG,         24,      1,            G2D_CFG,            0,         4,          0,          0,          0,          G2D_CFG,         G2D_GATE,        G2D_GATE,      0,             31,         16,         0,              0,             &clk_lock, NULL,             0);
...
void init_clocks(void)
{
	...
	sunxi_clk_periph_losc_out.gate.bus = (void *)0x07000060;

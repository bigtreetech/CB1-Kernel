...
#define CHECKED_SK_CMP_FUNC(type, p)                                           \
	((int (*)(const char *const *, const char *const *))(                  \
		(1 ? p :                                                       \
		     (int (*)(const type *const *, const type *const *))0)))
...
#define SKM_sk_unshift(type, st, val)                                          \
	sk_unshift(CHECKED_PTR_OF(STACK_OF(type), st),                         \
...
#define SKM_sk_insert(type, st, val, i)                                        \
	sk_insert(CHECKED_PTR_OF(STACK_OF(type), st),                          \
		  CHECKED_PTR_OF(type, val), i)
#define SKM_sk_set_cmp_func(type, st, cmp)                                     \
	((int (*)(const type *const *, const type *const *))sk_set_cmp_func(   \
		CHECKED_PTR_OF(STACK_OF(type), st),                            \
		CHECKED_SK_CMP_FUNC(type, cmp)))
...
#define SKM_ASN1_seq_unpack(type, buf, len, d2i_func, free_func)               \
	(STACK_OF(type) *)ASN1_seq_unpack(                                     \
		buf, len, CHECKED_D2I_OF(type, d2i_func),                      \
		CHECKED_SK_FREE_FUNC(type, free_func))

#define SKM_PKCS12_decrypt_d2i(type, algor, d2i_func, free_func, pass,         \
			       passlen, oct, seq)                              \
	(STACK_OF(type) *)PKCS12_decrypt_d2i(                                  \
		algor, CHECKED_D2I_OF(type, d2i_func),                         \
		CHECKED_SK_FREE_FUNC(type, free_func), pass, passlen, oct,     \
		seq)
...
#define SKM_sk_unshift(type, st, val) sk_unshift(st, (char *)val)
...
#define SKM_ASN1_SET_OF_i2d(type, st, pp, i2d_func, ex_tag, ex_class, is_set)  \
	i2d_ASN1_SET(st, pp, (int (*)(void *, unsigned char **))i2d_func,      \
		     ex_tag, ex_class, is_set)

#define SKM_ASN1_seq_pack(type, st, i2d_func, buf, len)                        \
	ASN1_seq_pack(st, (int (*)(void *, unsigned char **))i2d_func, buf, len)
#define SKM_ASN1_seq_unpack(type, buf, len, d2i_func, free_func)               \
	ASN1_seq_unpack(buf, len, (void *(*)(void **, const unsigned char **,  \
					     long))d2i_func,                   \
			(void (*)(void *))free_func)
...
#define sk_CMS_CertificateChoices_new(st)                                      \
	SKM_sk_new(CMS_CertificateChoices, (st))
#define sk_CMS_CertificateChoices_new_null()                                   \
	SKM_sk_new_null(CMS_CertificateChoices)
#define sk_CMS_CertificateChoices_free(st)                                     \
	SKM_sk_free(CMS_CertificateChoices, (st))
#define sk_CMS_CertificateChoices_num(st)                                      \
	SKM_sk_num(CMS_CertificateChoices, (st))
#define sk_CMS_CertificateChoices_value(st, i)                                 \
...
#define sk_CMS_CertificateChoices_zero(st)                                     \
	SKM_sk_zero(CMS_CertificateChoices, (st))
#define sk_CMS_CertificateChoices_push(st, val)                                \
...
#define sk_CMS_CertificateChoices_find(st, val)                                \
	SKM_sk_find(CMS_CertificateChoices, (st), (val))
#define sk_CMS_CertificateChoices_find_ex(st, val)                             \
	SKM_sk_find_ex(CMS_CertificateChoices, (st), (val))
#define sk_CMS_CertificateChoices_delete(st, i)                                \
...
#define sk_CMS_CertificateChoices_shift(st)                                    \
	SKM_sk_shift(CMS_CertificateChoices, (st))
#define sk_CMS_CertificateChoices_pop(st)                                      \
	SKM_sk_pop(CMS_CertificateChoices, (st))
#define sk_CMS_CertificateChoices_sort(st)                                     \
	SKM_sk_sort(CMS_CertificateChoices, (st))
#define sk_CMS_CertificateChoices_is_sorted(st)                                \
...
#define sk_CMS_RecipientInfo_value(st, i)                                      \
	SKM_sk_value(CMS_RecipientInfo, (st), (i))
#define sk_CMS_RecipientInfo_set(st, i, val)                                   \
	SKM_sk_set(CMS_RecipientInfo, (st), (i), (val))
#define sk_CMS_RecipientInfo_zero(st) SKM_sk_zero(CMS_RecipientInfo, (st))
#define sk_CMS_RecipientInfo_push(st, val)                                     \
	SKM_sk_push(CMS_RecipientInfo, (st), (val))
#define sk_CMS_RecipientInfo_unshift(st, val)                                  \
	SKM_sk_unshift(CMS_RecipientInfo, (st), (val))
#define sk_CMS_RecipientInfo_find(st, val)                                     \
	SKM_sk_find(CMS_RecipientInfo, (st), (val))
#define sk_CMS_RecipientInfo_find_ex(st, val)                                  \
	SKM_sk_find_ex(CMS_RecipientInfo, (st), (val))
#define sk_CMS_RecipientInfo_delete(st, i)                                     \
	SKM_sk_delete(CMS_RecipientInfo, (st), (i))
#define sk_CMS_RecipientInfo_delete_ptr(st, ptr)                               \
	SKM_sk_delete_ptr(CMS_RecipientInfo, (st), (ptr))
#define sk_CMS_RecipientInfo_insert(st, val, i)                                \
...
#define sk_CMS_RecipientInfo_is_sorted(st)                                     \
	SKM_sk_is_sorted(CMS_RecipientInfo, (st))

#define sk_CMS_RevocationInfoChoice_new(st)                                    \
	SKM_sk_new(CMS_RevocationInfoChoice, (st))
#define sk_CMS_RevocationInfoChoice_new_null()                                 \
	SKM_sk_new_null(CMS_RevocationInfoChoice)
#define sk_CMS_RevocationInfoChoice_free(st)                                   \
	SKM_sk_free(CMS_RevocationInfoChoice, (st))
#define sk_CMS_RevocationInfoChoice_num(st)                                    \
	SKM_sk_num(CMS_RevocationInfoChoice, (st))
#define sk_CMS_RevocationInfoChoice_value(st, i)                               \
...
#define sk_CMS_RevocationInfoChoice_zero(st)                                   \
	SKM_sk_zero(CMS_RevocationInfoChoice, (st))
#define sk_CMS_RevocationInfoChoice_push(st, val)                              \
...
#define sk_CMS_RevocationInfoChoice_find(st, val)                              \
	SKM_sk_find(CMS_RevocationInfoChoice, (st), (val))
#define sk_CMS_RevocationInfoChoice_find_ex(st, val)                           \
	SKM_sk_find_ex(CMS_RevocationInfoChoice, (st), (val))
#define sk_CMS_RevocationInfoChoice_delete(st, i)                              \
...
#define sk_CMS_RevocationInfoChoice_dup(st)                                    \
...
#define sk_CMS_RevocationInfoChoice_shift(st)                                  \
	SKM_sk_shift(CMS_RevocationInfoChoice, (st))
#define sk_CMS_RevocationInfoChoice_pop(st)                                    \
	SKM_sk_pop(CMS_RevocationInfoChoice, (st))
#define sk_CMS_RevocationInfoChoice_sort(st)                                   \
	SKM_sk_sort(CMS_RevocationInfoChoice, (st))
#define sk_CMS_RevocationInfoChoice_is_sorted(st)                              \
...
#define sk_GENERAL_NAMES_set(st, i, val)                                       \
	SKM_sk_set(GENERAL_NAMES, (st), (i), (val))
#define sk_GENERAL_NAMES_zero(st) SKM_sk_zero(GENERAL_NAMES, (st))
#define sk_GENERAL_NAMES_push(st, val) SKM_sk_push(GENERAL_NAMES, (st), (val))
#define sk_GENERAL_NAMES_unshift(st, val)                                      \
	SKM_sk_unshift(GENERAL_NAMES, (st), (val))
#define sk_GENERAL_NAMES_find(st, val) SKM_sk_find(GENERAL_NAMES, (st), (val))
#define sk_GENERAL_NAMES_find_ex(st, val)                                      \
	SKM_sk_find_ex(GENERAL_NAMES, (st), (val))
#define sk_GENERAL_NAMES_delete(st, i) SKM_sk_delete(GENERAL_NAMES, (st), (i))
#define sk_GENERAL_NAMES_delete_ptr(st, ptr)                                   \
	SKM_sk_delete_ptr(GENERAL_NAMES, (st), (ptr))
#define sk_GENERAL_NAMES_insert(st, val, i)                                    \
	SKM_sk_insert(GENERAL_NAMES, (st), (val), (i))
#define sk_GENERAL_NAMES_set_cmp_func(st, cmp)                                 \
	SKM_sk_set_cmp_func(GENERAL_NAMES, (st), (cmp))
#define sk_GENERAL_NAMES_dup(st) SKM_sk_dup(GENERAL_NAMES, st)
#define sk_GENERAL_NAMES_pop_free(st, free_func)                               \
...
#define sk_OCSP_RESPID_delete_ptr(st, ptr)                                     \
	SKM_sk_delete_ptr(OCSP_RESPID, (st), (ptr))
#define sk_OCSP_RESPID_insert(st, val, i)                                      \
	SKM_sk_insert(OCSP_RESPID, (st), (val), (i))
#define sk_OCSP_RESPID_set_cmp_func(st, cmp)                                   \
	SKM_sk_set_cmp_func(OCSP_RESPID, (st), (cmp))
#define sk_OCSP_RESPID_dup(st) SKM_sk_dup(OCSP_RESPID, st)
#define sk_OCSP_RESPID_pop_free(st, free_func)                                 \
...
#define d2i_ASN1_SET_OF_ACCESS_DESCRIPTION(st, pp, length, d2i_func,           \
	...
	SKM_ASN1_SET_OF_d2i(ACCESS_DESCRIPTION, (st), (pp), (length),          \
			    (d2i_func), (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_ACCESS_DESCRIPTION(st, pp, i2d_func, ex_tag, ex_class, \
					   is_set)                             \
	SKM_ASN1_SET_OF_i2d(ACCESS_DESCRIPTION, (st), (pp), (i2d_func),        \
			    (ex_tag), (ex_class), (is_set))
#define ASN1_seq_pack_ACCESS_DESCRIPTION(st, i2d_func, buf, len)               \
	SKM_ASN1_seq_pack(ACCESS_DESCRIPTION, (st), (i2d_func), (buf), (len))
#define ASN1_seq_unpack_ACCESS_DESCRIPTION(buf, len, d2i_func, free_func)      \
	SKM_ASN1_seq_unpack(ACCESS_DESCRIPTION, (buf), (len), (d2i_func),      \
			    (free_func))
...
#define i2d_ASN1_SET_OF_ASN1_TYPE(st, pp, i2d_func, ex_tag, ex_class, is_set)  \
	SKM_ASN1_SET_OF_i2d(ASN1_TYPE, (st), (pp), (i2d_func), (ex_tag),       \
			    (ex_class), (is_set))
...
#define ASN1_seq_unpack_OCSP_SINGLERESP(buf, len, d2i_func, free_func)         \
	SKM_ASN1_seq_unpack(OCSP_SINGLERESP, (buf), (len), (d2i_func),         \
			    (free_func))
...
#define ASN1_seq_unpack_PKCS12_SAFEBAG(buf, len, d2i_func, free_func)          \
	SKM_ASN1_seq_unpack(PKCS12_SAFEBAG, (buf), (len), (d2i_func),          \
			    (free_func))

#define d2i_ASN1_SET_OF_PKCS7(st, pp, length, d2i_func, free_func, ex_tag,     \
			      ex_class)                                        \
	SKM_ASN1_SET_OF_d2i(PKCS7, (st), (pp), (length), (d2i_func),           \
			    (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_PKCS7(st, pp, i2d_func, ex_tag, ex_class, is_set)      \
	SKM_ASN1_SET_OF_i2d(PKCS7, (st), (pp), (i2d_func), (ex_tag),           \
			    (ex_class), (is_set))
...
#define d2i_ASN1_SET_OF_PKCS7_RECIP_INFO(st, pp, length, d2i_func, free_func,  \
					 ex_tag, ex_class)                     \
	SKM_ASN1_SET_OF_d2i(PKCS7_RECIP_INFO, (st), (pp), (length),            \
			    (d2i_func), (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_PKCS7_RECIP_INFO(st, pp, i2d_func, ex_tag, ex_class,   \
					 is_set)                               \
	SKM_ASN1_SET_OF_i2d(PKCS7_RECIP_INFO, (st), (pp), (i2d_func),          \
			    (ex_tag), (ex_class), (is_set))
#define ASN1_seq_pack_PKCS7_RECIP_INFO(st, i2d_func, buf, len)                 \
	SKM_ASN1_seq_pack(PKCS7_RECIP_INFO, (st), (i2d_func), (buf), (len))
#define ASN1_seq_unpack_PKCS7_RECIP_INFO(buf, len, d2i_func, free_func)        \
	SKM_ASN1_seq_unpack(PKCS7_RECIP_INFO, (buf), (len), (d2i_func),        \
			    (free_func))

#define d2i_ASN1_SET_OF_PKCS7_SIGNER_INFO(st, pp, length, d2i_func, free_func, \
					  ex_tag, ex_class)                    \
	SKM_ASN1_SET_OF_d2i(PKCS7_SIGNER_INFO, (st), (pp), (length),           \
			    (d2i_func), (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_PKCS7_SIGNER_INFO(st, pp, i2d_func, ex_tag, ex_class,  \
					  is_set)                              \
	SKM_ASN1_SET_OF_i2d(PKCS7_SIGNER_INFO, (st), (pp), (i2d_func),         \
			    (ex_tag), (ex_class), (is_set))
#define ASN1_seq_pack_PKCS7_SIGNER_INFO(st, i2d_func, buf, len)                \
	SKM_ASN1_seq_pack(PKCS7_SIGNER_INFO, (st), (i2d_func), (buf), (len))
#define ASN1_seq_unpack_PKCS7_SIGNER_INFO(buf, len, d2i_func, free_func)       \
	SKM_ASN1_seq_unpack(PKCS7_SIGNER_INFO, (buf), (len), (d2i_func),       \
			    (free_func))
...
#define ASN1_seq_unpack_POLICYQUALINFO(buf, len, d2i_func, free_func)          \
	SKM_ASN1_seq_unpack(POLICYQUALINFO, (buf), (len), (d2i_func),          \
			    (free_func))

#define d2i_ASN1_SET_OF_SXNETID(st, pp, length, d2i_func, free_func, ex_tag,   \
				ex_class)                                      \
	SKM_ASN1_SET_OF_d2i(SXNETID, (st), (pp), (length), (d2i_func),         \
			    (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_SXNETID(st, pp, i2d_func, ex_tag, ex_class, is_set)    \
	SKM_ASN1_SET_OF_i2d(SXNETID, (st), (pp), (i2d_func), (ex_tag),         \
			    (ex_class), (is_set))
...
#define d2i_ASN1_SET_OF_X509(st, pp, length, d2i_func, free_func, ex_tag,      \
			     ex_class)                                         \
	SKM_ASN1_SET_OF_d2i(X509, (st), (pp), (length), (d2i_func),            \
			    (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_X509(st, pp, i2d_func, ex_tag, ex_class, is_set)       \
	SKM_ASN1_SET_OF_i2d(X509, (st), (pp), (i2d_func), (ex_tag),            \
			    (ex_class), (is_set))
...
#define ASN1_seq_unpack_X509_ATTRIBUTE(buf, len, d2i_func, free_func)          \
	SKM_ASN1_seq_unpack(X509_ATTRIBUTE, (buf), (len), (d2i_func),          \
			    (free_func))

#define d2i_ASN1_SET_OF_X509_CRL(st, pp, length, d2i_func, free_func, ex_tag,  \
				 ex_class)                                     \
	SKM_ASN1_SET_OF_d2i(X509_CRL, (st), (pp), (length), (d2i_func),        \
			    (free_func), (ex_tag), (ex_class))
#define i2d_ASN1_SET_OF_X509_CRL(st, pp, i2d_func, ex_tag, ex_class, is_set)   \
	SKM_ASN1_SET_OF_i2d(X509_CRL, (st), (pp), (i2d_func), (ex_tag),        \
			    (ex_class), (is_set))
...
#define ASN1_seq_unpack_X509_EXTENSION(buf, len, d2i_func, free_func)          \
	SKM_ASN1_seq_unpack(X509_EXTENSION, (buf), (len), (d2i_func),          \
			    (free_func))
...
#define ASN1_seq_unpack_X509_NAME_ENTRY(buf, len, d2i_func, free_func)         \
	SKM_ASN1_seq_unpack(X509_NAME_ENTRY, (buf), (len), (d2i_func),         \
			    (free_func))
...
#define PKCS12_decrypt_d2i_PKCS12_SAFEBAG(algor, d2i_func, free_func, pass,    \
					  passlen, oct, seq)                   \
	SKM_PKCS12_decrypt_d2i(PKCS12_SAFEBAG, (algor), (d2i_func),            \
			       (free_func), (pass), (passlen), (oct), (seq))

#define PKCS12_decrypt_d2i_PKCS7(algor, d2i_func, free_func, pass, passlen,    \
				 oct, seq)                                     \
	SKM_PKCS12_decrypt_d2i(PKCS7, (algor), (d2i_func), (free_func),        \

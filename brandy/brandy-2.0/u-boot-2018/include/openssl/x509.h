...
#define X509_verify(a, r)                                                      \
	ASN1_verify((int (*)())i2d_X509_CINF, a->sig_alg, a->signature,        \
		    (char *)a->cert_info, r)
#define X509_REQ_verify(a, r)                                                  \
	ASN1_verify((int (*)())i2d_X509_REQ_INFO, a->sig_alg, a->signature,    \
		    (char *)a->req_info, r)
...
#define X509_dup(x509)                                                         \
	(X509 *)ASN1_dup((int (*)())i2d_X509, (char *(*)())d2i_X509,           \
			 (char *)x509)
#define X509_ATTRIBUTE_dup(xa)                                                 \
	(X509_ATTRIBUTE *)ASN1_dup((int (*)())i2d_X509_ATTRIBUTE,              \
				   (char *(*)())d2i_X509_ATTRIBUTE,            \
				   (char *)xa)
#define X509_EXTENSION_dup(ex)                                                 \
	(X509_EXTENSION *)ASN1_dup((int (*)())i2d_X509_EXTENSION,              \
				   (char *(*)())d2i_X509_EXTENSION,            \
				   (char *)ex)
#define d2i_X509_fp(fp, x509)                                                  \
	(X509 *)ASN1_d2i_fp((char *(*)())X509_new, (char *(*)())d2i_X509,      \
			    (fp), (unsigned char **)(x509))
#define i2d_X509_fp(fp, x509) ASN1_i2d_fp(i2d_X509, fp, (unsigned char *)x509)
#define d2i_X509_bio(bp, x509)                                                 \
	(X509 *)ASN1_d2i_bio((char *(*)())X509_new, (char *(*)())d2i_X509,     \
			     (bp), (unsigned char **)(x509))
#define i2d_X509_bio(bp, x509) ASN1_i2d_bio(i2d_X509, bp, (unsigned char *)x509)

#define X509_CRL_dup(crl)                                                      \
	(X509_CRL *)ASN1_dup((int (*)())i2d_X509_CRL,                          \
			     (char *(*)())d2i_X509_CRL, (char *)crl)
#define d2i_X509_CRL_fp(fp, crl)                                               \
	(X509_CRL *)ASN1_d2i_fp((char *(*)())X509_CRL_new,                     \
				(char *(*)())d2i_X509_CRL, (fp),               \
				(unsigned char **)(crl))
...
#define d2i_X509_CRL_bio(bp, crl)                                              \
	(X509_CRL *)ASN1_d2i_bio((char *(*)())X509_CRL_new,                    \
				 (char *(*)())d2i_X509_CRL, (bp),              \
				 (unsigned char **)(crl))
#define i2d_X509_CRL_bio(bp, crl)                                              \
	ASN1_i2d_bio(i2d_X509_CRL, bp, (unsigned char *)crl)

#define PKCS7_dup(p7)                                                          \
	(PKCS7 *)ASN1_dup((int (*)())i2d_PKCS7, (char *(*)())d2i_PKCS7,        \
			  (char *)p7)
#define d2i_PKCS7_fp(fp, p7)                                                   \
	(PKCS7 *)ASN1_d2i_fp((char *(*)())PKCS7_new, (char *(*)())d2i_PKCS7,   \
			     (fp), (unsigned char **)(p7))
#define i2d_PKCS7_fp(fp, p7) ASN1_i2d_fp(i2d_PKCS7, fp, (unsigned char *)p7)
#define d2i_PKCS7_bio(bp, p7)                                                  \
	(PKCS7 *)ASN1_d2i_bio((char *(*)())PKCS7_new, (char *(*)())d2i_PKCS7,  \
			      (bp), (unsigned char **)(p7))
#define i2d_PKCS7_bio(bp, p7) ASN1_i2d_bio(i2d_PKCS7, bp, (unsigned char *)p7)

#define X509_REQ_dup(req)                                                      \
	(X509_REQ *)ASN1_dup((int (*)())i2d_X509_REQ,                          \
			     (char *(*)())d2i_X509_REQ, (char *)req)
#define d2i_X509_REQ_fp(fp, req)                                               \
	(X509_REQ *)ASN1_d2i_fp((char *(*)())X509_REQ_new,                     \
				(char *(*)())d2i_X509_REQ, (fp),               \
				(unsigned char **)(req))
...
#define d2i_DSAPrivateKey_fp(fp, dsa)                                          \
	(DSA *)ASN1_d2i_fp((char *(*)())DSA_new,                               \
			   (char *(*)())d2i_DSAPrivateKey, (fp),               \
			   (unsigned char **)(dsa))
#define i2d_DSAPrivateKey_fp(fp, dsa)                                          \
	ASN1_i2d_fp(i2d_DSAPrivateKey, fp, (unsigned char *)dsa)
#define d2i_DSAPrivateKey_bio(bp, dsa)                                         \
	(DSA *)ASN1_d2i_bio((char *(*)())DSA_new,                              \
			    (char *(*)())d2i_DSAPrivateKey, (bp),              \
			    (unsigned char **)(dsa))
#define i2d_DSAPrivateKey_bio(bp, dsa)                                         \
	ASN1_i2d_bio(i2d_DSAPrivateKey, bp, (unsigned char *)dsa)

#define d2i_ECPrivateKey_fp(fp, ecdsa)                                         \
	(EC_KEY *)ASN1_d2i_fp((char *(*)())EC_KEY_new,                         \
			      (char *(*)())d2i_ECPrivateKey, (fp),             \
			      (unsigned char **)(ecdsa))
#define i2d_ECPrivateKey_fp(fp, ecdsa)                                         \
	ASN1_i2d_fp(i2d_ECPrivateKey, fp, (unsigned char *)ecdsa)
#define d2i_ECPrivateKey_bio(bp, ecdsa)                                        \
	(EC_KEY *)ASN1_d2i_bio((char *(*)())EC_KEY_new,                        \
			       (char *(*)())d2i_ECPrivateKey, (bp),            \
			       (unsigned char **)(ecdsa))
#define i2d_ECPrivateKey_bio(bp, ecdsa)                                        \
	ASN1_i2d_bio(i2d_ECPrivateKey, bp, (unsigned char *)ecdsa)

#define X509_ALGOR_dup(xn)                                                     \
	(X509_ALGOR *)ASN1_dup((int (*)())i2d_X509_ALGOR,                      \
			       (char *(*)())d2i_X509_ALGOR, (char *)xn)

#define X509_NAME_dup(xn)                                                      \
	(X509_NAME *)ASN1_dup((int (*)())i2d_X509_NAME,                        \
...
STACK_OF(X509_ATTRIBUTE) *
	X509at_add1_attr_by_OBJ(STACK_OF(X509_ATTRIBUTE) * *x,
				...
				const unsigned char *bytes, int len);
STACK_OF(X509_ATTRIBUTE) *
	X509at_add1_attr_by_NID(STACK_OF(X509_ATTRIBUTE) * *x, int nid,
				int type, const unsigned char *bytes, int len);
STACK_OF(X509_ATTRIBUTE) *
	X509at_add1_attr_by_txt(STACK_OF(X509_ATTRIBUTE) * *x,

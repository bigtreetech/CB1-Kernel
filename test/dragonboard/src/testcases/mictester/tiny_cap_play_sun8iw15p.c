...
void close_speaker()
{
	tinymix_set_value_byname(mixer,"Speaker Switch",0);
}

void set_to_speaker()
{
	//tinymix_set_value_byname(mixer,"AIF1IN0R Mux", (unsigned int)"AIF1_DA0R");
	tinymix_set_value_byname(mixer,"AIF1IN0R Mux", 0);
	//tinymix_set_value_byname(mixer,"AIF1IN0L Mux", (unsigned int)"AIF1_DA0L");
	tinymix_set_value_byname(mixer,"AIF1IN0L Mux", 0);
	...
	//tinymix_set_value_byname(mixer,"SPK_L Mux",(unsigned int)"MIXEL_Switch");
	//tinymix_set_value_byname(mixer,"SPK_L Mux",1);

	//tinymix_set_value_byname(mixer,"SPK_L Mux",(unsigned int)"MIXEL_Switch");
	//tinymix_set_value_byname(mixer,"SPK_R Mux",1);
	//tinymix_set_value_byname(mixer,"HP_R Mux", (unsigned int)"DACR_HPR_Switch");
	tinymix_set_value_byname(mixer,"HP_R Mux", 0);
	//tinymix_set_value_byname(mixer,"HP_L Mux", (unsigned int)"DACL_HPL_Switch");
	tinymix_set_value_byname(mixer,"HP_L Mux", 0);

	tinymix_set_value_byname(mixer,"headphone volume", 63);
...
void set_to_jack()
{
	...
	//tinymix_set_value_byname(mixer,"HP_L Mux", (unsigned int)"DACL_HPL_Switch");
	tinymix_set_value_byname(mixer,"HP_L Mux", 0);
	tinymix_set_value_byname(mixer,"headphone volume", 47);
...
void set_to_mainmic()
{
	tinymix_set_value_byname(mixer,"AIF1OUT0L Mux", 1);
	...
	tinymix_set_value_byname(mixer,"RADC input Mixer MIC2 boost Switch", 1);
	tinymix_set_value_byname(mixer,"MIC2 boost amplifier gain", 4);
	tinymix_set_value_byname(mixer,"MIC2 SRC", 0);
	mic1_used = 1;
	mic2_used = 0;
}
...
void set_to_headmic()
{
	//tinymix_set_value_byname(mixer,"AIF1OUT0L Mux", (unsigned int)"AIF1_AD0R");
	tinymix_set_value_byname(mixer,"AIF1OUT0L Mux", 1);
	//tinymix_set_value_byname(mixer,"AIF1OUT0R Mux", (unsigned int)"AIF1_AD0R");
	//tinymix_set_value_byname(mixer,"AIF1 AD0L Mixer ADCL Switch",1);
	tinymix_set_value_byname(mixer,"AIF1 AD0R Mixer ADCR Switch",1);
	...
	tinymix_set_value_byname(mixer,"RADC input Mixer MIC2 boost Switch", 1);
	tinymix_set_value_byname(mixer,"MIC2 boost amplifier gain", 4);
	//tinymix_set_value_byname(mixer,"MIC2 SRC", "MIC2");
	tinymix_set_value_byname(mixer,"MIC2 SRC", 1);
	mic1_used = 0;
	mic2_used = 1;
}

...
/* chip name for log */
#define CHIP_NAME "sun50iw1p"

/* headset detect info */
struct HsDetectInfo hsDetectInfo = {
    path:"/sys/module/sunxi_sndcodec/parameters/switch_state",
    SPK:0,
    HEADPHONE:1,
    HEADSET:3
};
...
struct kvpair interLbCtls[] = {
    ...
    {"LADC input Mixer MIC1 boost Switch", 0},
    {"RADC input Mixer MIC1 boost Switch", 0}
    {"LADC input Mixer MIC2 boost Switch", 0},
    {"RADC input Mixer MIC2 boost Switch", 0},
    {"LADC input Mixer l_output mixer Switch", 1},
    {"RADC input Mixer l_output mixer Switch", 1},
};
...
struct kvpair spkCtls[] = {
    ...
    {"ADCR Mux", (unsigned int)"ADC"},
    {"ADCL Mux", (unsigned int)"ADC"},
    {"LADC input Mixer MIC1 boost Switch", 1},
    {"RADC input Mixer MIC1 boost Switch", 1}
};
...
struct kvpair hsCtls[] = {
    ...
    {"LADC input Mixer MIC2 boost Switch", 1},
    {"RADC input Mixer MIC2 boost Switch", 1},
    {"ADCL Mux", (unsigned int)"ADC"},
    {"ADCR Mux", (unsigned int)"ADC"},
    {"AIF1 AD0L Mixer ADCL Switch", 1},
    {"AIF1 AD0R Mixer ADCR Switch", 1},

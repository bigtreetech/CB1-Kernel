#ifndef __SUN8IW5P_DISPLAY_H__
#define __SUN8IW5P_DISPLAY_H__
...
typedef struct
{
	unsigned int          addr[3];    // frame buffer�����ݵ�ַ������rgb���ͣ�ֻ��addr[0]��Ч
	disp_size             size;//��λ��pixel
...
typedef struct
{
    ...
    unsigned char             zorder;     //layer priority,can get layer prio,but never set layer prio,�ӵ�����,���ȼ��ɵ�����
...
typedef enum
{
	...
	DISP_INIT_MODE_SCREEN2 = 2, //fb0 for screen2
...
typedef struct
{
	...
	//for screen0 and screen1 and screen2
	disp_output_type      output_type[3];
	unsigned int          output_mode[3];

	//for fb0 and fb1 and fb2
